                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark" href="javascript:void(0)"
                           ...
                           aria-haspopup="true" aria-expanded="false">
                            <img @src="/images/admin/user-white.svg" alt="user" width="30"
                            ...
                            <ul class="dropdown-user list-style-none">
                                <li>
                                    <div class="dw-user-box p-3 d-flex">
                                        <div class="u-img"><img @src="/images/admin/user-black.svg" alt="user"
                                                                class="rounded" width="80"></div>
                                        <div class="u-text ml-2">
                                            <h4 class="mb-0">{{auth()->user()->name}}</h4>
                                            <p class="text-muted mb-1 font-14">{{auth()->user()->email}}</p>
                                            <a href="{{route('profile.index')}}"
                                               class="btn btn-rounded btn-danger btn-sm text-white d-inline-block">@lang('My Profile')</a>
                                        </div>
                                    </div>
                                </li>
                                <li role="separator" class="dropdown-divider"></li>
                                <li class="user-list">
                                    <a class="px-3 py-2" href="{{route('change-password.index')}}"><i
                                            class="ti-settings"></i> @lang('Change Password')</a>
                                </li>
                                <li role="separator" class="dropdown-divider"></li>
                                <li class="user-list">
                    ...
                    @if(Route::has('locale'))
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <a class="dropdown-item" href="/vi"><i
                                        class="flag-icon flag-icon-vi"></i> @lang('Vietnamese')</a>
                                <a class="dropdown-item" href="/en"><i
                                        class="flag-icon flag-icon-en"></i> @lang('English')</a>
                            </div>
                        </li>
                    @endif
                </ul>
        ...
        <div class="scroll-sidebar">
                ...
                <div class="profile-text pt-1">
                    ...
                    <div class="dropdown-menu animated flipInY">
                        <a href="{{route('profile.index')}}" class="dropdown-item"><i
                                class="ti-user"></i> @lang('My Profile')</a>
                        <div class="dropdown-divider"></div>
                        <a href="{{route('change-password.index')}}" class="dropdown-item"><i
                                class="ti-settings"></i> @lang('Change Password')</a>
                        <div class="dropdown-divider"></div>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{route('profile.index')}}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i><span
                                            class="hide-menu">@lang('My Profile')</span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{route('change-password.index')}}"
                                                            class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i><span
                                            class="hide-menu">@lang('Change Password')</span></a>
                                </li>
                            </ul>
                        </li>
                    @endif
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{route('service.index')}}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i><span
                                            class="hide-menu">@lang('All Services')</span></a>
                                </li>
                                ...
                                @if(Route::has('category.index'))
                                    <li class="sidebar-item"><a href="{{route('master.category', 'services')}}"
                                                                class="sidebar-link">
                                            <i class="mdi mdi-octagram"></i><span
                                                class="hide-menu">@lang('Categories')</span></a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{route('post.index')}}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i><span
                                            class="hide-menu">@lang('All Posts')</span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{route('post.create')}}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i><span class="hide-menu">@lang('Add New')</span></a>
                                </li>
                                @if(Route::has('category.index'))
                                    <li class="sidebar-item"><a href="{{route('master.category', 'posts')}}"
                                                                class="sidebar-link">
                                            <i class="mdi mdi-octagram"></i><span
                                                class="hide-menu">@lang('Categories')</span></a>
                                    </li>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{route('page.index')}}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i><span
                                            class="hide-menu">@lang('All Pages')</span></a>
                                </li>
                    ...
                    @endif
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark" href="{{route('cms.index')}}"
                           aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item"><a href="{{route('configuration.index', 'contact')}}"
                                                        class="sidebar-link">
                                    <i class="mdi mdi-octagram"></i><span class="hide-menu">@lang('Contact')</span></a>
                            </li>
                            <li class="sidebar-item"><a href="{{route('configuration.index', 'social')}}"
                                                        class="sidebar-link">
                                    <i class="mdi mdi-octagram"></i><span
                                        class="hide-menu">@lang('Social Network')</span></a>
                            </li>
                            <li class="sidebar-item"><a href="{{route('configuration.index', 'website')}}"
                                                        class="sidebar-link">

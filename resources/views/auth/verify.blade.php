            ...
            <div>
                ...
                <div class="row mt-3 form-material">
                    ...
                    @else
                        <div class="col-12">
                            <span
                                class="text-muted">@lang('Before proceeding, please check your email for a verification link.')</span>
                            <span class="text-muted">@lang('If you did not receive the email'),</span>
                            <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                @csrf
                                <button type="submit"
                                        class="btn btn-link text-info p-0 m-0 align-baseline">@lang('click here to request another')</button>
                                .
                            </form>
                        </div>
                    @endif

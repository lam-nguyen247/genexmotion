    ...
    <div class="row row-full-width" id="row-1377694405">
      <div id="col-916842809" class="col small-12 large-12">
          ...
          <div id="text-4214745138" class="text">
            <h3><span style="color: #282828;" data-cms="{{'vi'}}-text-index-1">CÁC DỰ ÁN ĐÃ THỰC HIỆN </span></h3>
            <p><span style="color: #282828;" data-cms="{{'vi'}}-title-index-2">Cùng khám phá các dự án đã được SocMedia triển khai trong thời gian qua.</span></p>
          </div>

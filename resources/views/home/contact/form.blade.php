              ...
              <div id="col-506578473" class="col medium-9 small-12 large-6">
                <div class="col-inner text-center">
                  ...
                  <ul>
                    ...
                    <li style="text-align: left;" data-cms="{{'vi'}}-form-index-4">HotLine: {{$config->phone}}</li>
                  </ul>
                </div>
                                    ...
                                    <div class="eapps-form-inner" eapps-link="formInner">
                                        <form class="eapps-form-form form-register-info">
                                            ...
                                            <div class="eapps-form-fieldset" eapps-link="fieldset">
                                                ...
                                                <div class="eapps-form-element-wrapper eapps-form-element-phone" style="width: 100%;">
                                                    <div class="eapps-form-element-label">
                                                        Số điện thoại
                                                    </div>
                                                    <div class="eapps-form-element-container" eapps-link="container">
                                                ...
                                                <div class="eapps-form-element-wrapper eapps-form-element-dropdown" style="width: 100%;">
                                                    <div class="eapps-form-element-label">
                                                        Dịch vụ
                                                    </div>
                                                <div class="eapps-form-element-container" eapps-link="container">

                    ...
                    <div class="col-inner">
                        ...
                        <div id="text-574663578" class="text">
                            <p data-cms="vi-footer-text-1" style="visibility: visible;">&nbsp;CÔNG TY CỔ PHẦN CÔNG NGHỆ
                                ...
                                Nội<br>- Số 28B, Ngõ 162 Khương Đình - Thanh Xuân - Hà Nội<br>Mã số thuế: 0109379379<br>Hotline:
                ...
                <div id="col-1882873573" class="col small-12 large-12">
                    <div class="col-inner text-center">
                        <div class="social-icons follow-icons full-width text-center"><a href="javascript:void(0)"
                                                                                         ...
                                                                                         aria-label="Follow on Facebook"><i
                                ...
                                title="Follow on Twitter" aria-label="Follow on Twitter"><i
                                    class="icon-twitter"></i></a><a href="javascript:void(0)"
                                                                    target="_blank" rel="noopener noreferrer nofollow"
                                                                    data-label="LinkedIn"
                                                                    class="icon plain  linkedin tooltip"
                                                                    title="Follow on LinkedIn"
                                                                    aria-label="Follow on LinkedIn"><i

<htm lang="en" class="js js csstransforms3d csstransitions">
    ...
    <head>
        ...
        @else
            ...
            <script type='text/javascript' src="{{ asset('wp-includes/js/jquery/jquery.minaf6c.js') }}" id='jquery-core-js'>
            </script>
            <script type='text/javascript' src="{{ asset('wp-includes/js/jquery/jquery-migrate.mind617.js') }}"
                id='jquery-migrate-js'></script>
            <script type='text/javascript' src="{{ asset('wp-includes/js/jquery/ui/core.min35d0.js') }}" id='jquery-ui-core-js'>
            </script>
        ...
        <body id="body-site" data-rsssl=1
            ...
            <script type='text/javascript'
                src="{{ asset('wp-includes/js/dist/vendor/regenerator-runtime.minb36a.js?ver=0.13.7') }}"
                id='regenerator-runtime-js'></script>
            <script type='text/javascript' src="{{ asset('wp-includes/js/dist/vendor/wp-polyfill.min2c7c.js?ver=3.15.0') }}"
                id='wp-polyfill-js'></script>
            <script type='text/javascript'
                src="{{ asset('wp-content/plugins/contact-form-7/includes/js/indexd03b.js?ver=5.5.1') }}" id='contact-form-7-js'>
            </script>
            <script type='text/javascript'
            ...
            <script type='text/javascript' src="{{ asset('wp-includes/js/wp-embed.minc8d8.js?ver=5.8.3') }}" id='wp-embed-js'>
            </script>
            <script type='text/javascript'

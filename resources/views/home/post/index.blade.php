...
@section('description',
    'SocMedia Animation ĐĂNG KÝ Đăng ký Làm Video Motion Graphic Chuyên Nghiệp 00 00 00 00 Ngày Giờ
    Phút Giây Đăng ký ngay để nhận ưu đãi 300.000VNĐ THU HÚT VÀ ĐÁNH TRÚNG TÂM LÝKHÁCH HÀNG NHỜ VIDEO ANIMATION BỪNG SÁNG
    THƯƠNG HIỆU – BÙNG NỔ DOANH SỐ Nhờ chuyển động đẹp mắt')
@section('css')
@endsection
                                ...
                                <div class="box box-text-bottom box-blog-post has-hover">
                                    ...
                                    <div class="box-text text-left">
                                        <div class="box-text-inner blog-post-inner">
                                            ...
                                            <p class="from_the_blog_excerpt ">{!! Str::limit($post->content, 250, $end = '...(xem thêm)') !!}</p>
                                        </div>
                                    </div>
                                </div>
                            </a>

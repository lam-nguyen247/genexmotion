        ...
        <div class="service-item">
            <a href="/dich-vu_san-xuat-video-theo-yeu-cau" class="service-link">
                <div class="service-inner">
                    ...
                    <p data-cms="{{app()->getLocale()}}-service-home-video-content" style="text-align: justify;">
        ...
        <div class="service-item">
            <a href="/dich-vu-cung-cap-group-facebook" class="service-link">
                   <div class="service-inner">
                       ...
                       <p data-cms="{{app()->getLocale()}}-service-home-marketing-content" style="text-align: justify;">
